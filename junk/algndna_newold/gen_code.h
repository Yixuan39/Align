...
class Genetic_code 
{
 public:
  ...
  //Phony constructor to allow derived classes
...
{
 public:
  Univ_genetic_code() : Genetic_code () {};
  Univ_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file) :
    Genetic_code(cexchange, TRUE, "\0") {};
};

class Vert_mito_genetic_code : public Genetic_code
{
 public:
  Vert_mito_genetic_code() : Genetic_code () {};
  Vert_mito_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file);
 protected:
  void make_code();
}; 
...
{
 public:
  Yeast_mito_genetic_code() : Genetic_code () {};
  Yeast_mito_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file);
 protected:
  void make_code();
};
...
{
 public:
  Mold_mito_genetic_code() : Genetic_code () {};
  Mold_mito_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file);
 protected:
  void make_code();
};
...
{
 public:
  Invert_mito_genetic_code() : Genetic_code () {};
  Invert_mito_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file);
 protected:
  void make_code();
};
...
{
 public:
  Ciliate_nuc_genetic_code() : Genetic_code () {};
  Ciliate_nuc_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file);
 protected:
  void make_code();
};
...
{
 public:
  Echino_mito_genetic_code() : Genetic_code () {};
  Echino_mito_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file);
 protected:
  void make_code();
};
...
{
public:
	Mycoplasma_genetic_code() : Genetic_code() {};
	Mycoplasma_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file);
protected:
	void make_code();
};
