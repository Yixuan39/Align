...
{
  cerr<<"Default genetic code constructor called\n";
  aa_diffs=0;
}
...
//Genetic_code private functions
Vert_mito_genetic_code::Vert_mito_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file) :
...
Yeast_mito_genetic_code::Yeast_mito_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file) :
  Genetic_code(cexchange)
{
  curr_exchange=cexchange;
  if(standard_code==FALSE)
...
Mold_mito_genetic_code::Mold_mito_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file) :
  Genetic_code(cexchange)
{
  curr_exchange=cexchange;
  if(standard_code==FALSE)
...
Invert_mito_genetic_code::Invert_mito_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file) :
  Genetic_code(cexchange)
{
  curr_exchange=cexchange;
  if(standard_code==FALSE)
...
Ciliate_nuc_genetic_code::Ciliate_nuc_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file) :
  Genetic_code(cexchange)
{
  curr_exchange=cexchange;
  if(standard_code==FALSE)
...
Echino_mito_genetic_code::Echino_mito_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file) :
  Genetic_code(cexchange)
{
  curr_exchange=cexchange;
  if(standard_code==FALSE)
...
Mycoplasma_genetic_code::Mycoplasma_genetic_code(Exchange *cexchange, BOOL standard_code, char *code_file) :
  Genetic_code(cexchange)
{
  curr_exchange=cexchange;
  if(standard_code==FALSE)
...
Genetic_code * create_genetic_code(Exchange *curr_exchange)
{
  ...
  case UNIVERSAL:
    code = new Univ_genetic_code(curr_exchange, TRUE, "\0");
    break;
  case VERT_MITO:
    code = new Vert_mito_genetic_code(curr_exchange, TRUE, "\0");
    break;
  case YEAST_MITO:
    code = new Yeast_mito_genetic_code(curr_exchange, TRUE, "\0");
    break;
  case MOLD_MITO:
    code = new Mold_mito_genetic_code(curr_exchange, TRUE, "\0");
    break;
    case INVERT_MITO:
      code = new Invert_mito_genetic_code(curr_exchange, TRUE, "\0");
    break;
  case CILIATE_NUC:
    code = new Ciliate_nuc_genetic_code(curr_exchange, TRUE, "\0");
    break;
  case ECHINO_MITO:
    code = new Echino_mito_genetic_code(curr_exchange, TRUE, "\0");
    break;
  case MYCOPLASMA:
	  code = new Mycoplasma_genetic_code(curr_exchange, TRUE, "\0");
	  break;
  }
